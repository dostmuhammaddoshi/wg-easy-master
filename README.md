...
```
  ...
  https://github.com/dostmuhammaddoshi/wg-easy-master
```
...
| `PASSWORD` (deprecated)   | -                 | `foobar123`                    | When set, requires a password when logging in to the Web UI. _(Not used if `PASSWORD_HASH` is set)_                                                                                                                      |
